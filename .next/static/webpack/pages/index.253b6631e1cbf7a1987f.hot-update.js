...
function HomePage() {
  ...
  var changereadMore = function changereadMore() {
    ...
    if (dots.style.display === "block") {
      dots.style.display = extraContent.style.display === "none";
      setreadMore(true);
    } else {

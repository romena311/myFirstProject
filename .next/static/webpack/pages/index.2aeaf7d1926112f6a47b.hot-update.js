    ...
    value: function render() {
      ...
      var changereadMore = function changereadMore() {
        if (dots.style.display === "none") {
          extraContent.style.setreadMore(true);
        } else {
          setreadMore(false);
        }
      };

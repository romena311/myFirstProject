...
function HomePage() {
  ...
  var changereadMore = function changereadMore() {
    ...
    if (dots.style.display === "none") {
      ...
      btnText.innerHTML = extraContent.style.display = "none";
      setreadMore(true);
    } else {

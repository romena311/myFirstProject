    ...
    value: function render() {
      ...
      var changereadMore = function changereadMore() {
        if (dots.style.display === "none") {
          extraContent.style.display === setreadMore(true);
        } else {
          setreadMore(false);
        }
      };

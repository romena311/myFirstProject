...
function HomePage() {
  ...
  var changereadMore = function changereadMore() {
    ...
    if (dots.style.display === "none") {
      dots.extraContent.style.display = "none";
      setreadMore(true);
    } else {

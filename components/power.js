...
class PowerIcon extends Component {
    render() {
        return (
            <svg width="48" height="43" fill="white" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" xmlnsXlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 512 512">
                <g>
                    <g>
                        <g>

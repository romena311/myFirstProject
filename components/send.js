...
//Icon Paper-plane
class IconSend extends Component {
    render() {
        return (
            <svg className="send" width="34" height="38" fill="currentColor" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 469.335 469.335" xmlSpace="preserve" aria-labelledby="title">
